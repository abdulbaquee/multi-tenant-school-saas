            ...
            <nav class="p-3" aria-label="{{ __('Primary navigation') }}">
                ...
                <ul class="nav nav-pills flex-column gap-1">
                    ...
                    @if (auth()->user()->can('viewAny', \App\Models\FeeCategory::class) || auth()->user()->can('viewAny', \App\Models\StudentFee::class))
                        <li class="nav-item">
                            <a class="nav-link sidebar-link @if (request()->routeIs('fee-categories.*') || request()->routeIs('fee-structures.*') || request()->routeIs('student-fees.*') || request()->routeIs('fee-collections.*') || request()->routeIs('fee-payments.*') || request()->routeIs('fee-outstanding-balances.*')) active @endif" href="{{ auth()->user()->can('viewAny', \App\Models\FeeCategory::class) ? route('fee-categories.index') : route('fee-payments.index') }}" @if (request()->routeIs('fee-categories.*') || request()->routeIs('fee-structures.*') || request()->routeIs('student-fees.*') || request()->routeIs('fee-collections.*') || request()->routeIs('fee-payments.*') || request()->routeIs('fee-outstanding-balances.*')) aria-current="page" @endif>
